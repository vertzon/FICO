...
@copy blazeGenerics.server build\tmp\WEB-INF\classes%package%\ndconfig.server
@REM 
@REM setup:
@REM       WEB-INF/web.xml
@REM
...
@copy C:\FICO\GIT\Blaze\Projetos\BlazeGenerics\javaProjects\BOM_Generic\Export\blazeGenerics1.1.jar build\tmp\WEB-INF\lib\blazeGenerics1.1.jar
@REM
...
@cd build\tmp
@"%JAVA_HOME%\bin\jar.exe" Mcf ..\BlazeGenericsServer.war .
